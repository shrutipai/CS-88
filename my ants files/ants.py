    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if insect.name == 'Queen':
                if len(insect.true_queen) == 1:
                    return 
                else: 
                    del insect.true_queen[-1]
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        """
        while len(bees) == 0 and place != beehive:
...
# END Problem 13
    ...
    def double_damage(self, ant):
        if ant != None and ant.doubled == False:
    ...
    def action(self, colony):
        ...
        # BEGIN Problem 13
        "*** YOUR CODE HERE ***"
        if len(self.true_queen) > 1:
            self.reduce_armor(self.armor)
            del self.true_queen[-1]
            return
        ScubaThrower.action(self, colony)
        place = self.place.exit
        while place != None:
            QueenAnt.double_damage(self, place.ant)
            place = place.exit 
